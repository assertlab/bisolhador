          ...
          <div className="space-y-6 animate-fade-in-up">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <StatCard
                ...
                value={repoData.metrics.leadTime.value === 'N/A' ? 'N/A' : repoData.metrics.leadTime.value + ' ' + t('units.' + repoData.metrics.leadTime.unit, {count: repoData.metrics.leadTime.count})}
              ...
              <StatCard
                ...
                subValue={t(repoData.metrics.divergence.categoryKey)}
